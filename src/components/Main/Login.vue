    ...
    <div class="login">
      ...
      <div class="login-form">
          ...
          <p>
            ...
            <input id="username" class="form-control font-style text-gray" name="username" placeholder="用户名13" @keyup.enter="loginPre($validation1.valid)"
          ...
          <button v-if="!status && !clickLogin" class="btn-login" @click="loginPre($validation1.valid)">登&nbsp;&nbsp;录123
          </button>
